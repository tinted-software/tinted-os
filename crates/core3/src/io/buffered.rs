...
use crate::io::{
	BufRead, Error, ErrorKind, Read, Result, Seek, SeekFrom, Write,
};
use core::{cmp, fmt};
	...
	W: Write,
{
	...
	pub fn into_inner(
		mut self,
	) -> core::result::Result<W, IntoInnerError<BufWriter<W, S>>> {
...
impl<W: Write, const S: usize> LineWriter<W, S> {
	...
	pub fn into_inner(
		self,
	) -> core::result::Result<W, IntoInnerError<LineWriter<W, S>>> {
